export const en = {
  ...
  'review.intro.daily': 'A few minutes on what today is. Late work first, then anything unfiled, then what you have actually committed to.',
  'review.intro.weekly': 'A longer pass: what the week was, what slipped, and what next week is being asked to hold.',
  'review.step.overdue': 'Behind schedule',
  'review.step.inbox': 'Unfiled',
  ...
  'review.step.parked': 'Parked',
  'review.step.ahead': 'The week ahead',
  'review.ask.overdue': 'These have a date that has passed. Move each one, or park it — the one thing not to do is leave it lying where it is.',
  'review.ask.inbox': 'Captured and not yet filed. Decide when, and the project can follow later.',
  'review.ask.anytime': 'Committed to this week without a day. Anything you intend to do today should say so.',
  'review.ask.today': 'What today is holding, against the capacity you set for it.',
  'review.ask.done': 'What you finished this week. Nothing to decide here — it is worth seeing.',
  'review.ask.slipped': 'Dated for a day that has gone. Carry it, commit it to the week, or let it go.',
  'review.ask.unestimated': 'These are in play this week and carry no estimate, so none of them counts towards your load.',
  'review.ask.quiet': 'These projects hold open work and nothing in them was finished recently. Some of that is fine. Some of it is a project you have quietly stopped doing.',
  'review.ask.parked': 'The backlog. Read it, and pull back anything whose moment has come.',
  'review.ask.ahead': 'What next week is being asked to hold, against your weekly capacity.',
  'review.to.today': 'Today',
  'review.to.anytime': 'This week',
  'review.to.someday': 'Park',
  'review.back': 'Back',
  'review.next': 'Next',
